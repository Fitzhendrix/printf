...
/**
*write_num - Write a numb using a buff.
...
/**
*write_unsgnd - Writes an unsigned numb.
*@is_negative: Numb indicating if the num is negative.
...
*@ind: Index at which the numb starts in the buff.
